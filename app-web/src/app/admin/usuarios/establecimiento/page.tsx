...
import { FiHome, FiSearch, FiPlus, FiEdit, FiTrash2, FiEye } from 'react-icons/fi';
import { PageLayout, DataTable, TableHeader, TableRow, CreateUserModal, UserDetailsModal, UserEditModal } from '@/components';

export default function UsuariosEstablecimientoPage() {
  ...
  const [users, setUsers] = useState([
    {
      id: '1',
      name: 'María González',
      email: 'maria.gonzalez@establecimiento.com',
      role: 'manager',
      status: 'active',
      lastLogin: '2024-01-15 14:30',
      company: 'Establecimiento ABC'
    },
    {
      id: '2',
      name: 'Carlos López',
      email: 'carlos.lopez@establecimiento.com',
      role: 'agent',
      status: 'active',
      lastLogin: '2024-01-14 16:45',
      company: 'Establecimiento XYZ'
    },
    {
      id: '3',
      name: 'Ana Rodríguez',
      email: 'ana.rodriguez@establecimiento.com',
      role: 'client',
      status: 'pending',
      lastLogin: '2024-01-13 11:15',
      company: 'Establecimiento 123'
    }
  ]);

  const handleExport = () => {
    console.log('Exportando usuarios de establecimiento...');
  };
  ...
  return (
    <PageLayout
      ...
      description="Gestión de usuarios de establecimientos comerciales"
      showBackButton={true}
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 mb-6">
        <div className="flex-1 relative">
          ...
          <input
            type="text"
            placeholder="Buscar usuarios de establecimiento..."
      ...
      <div className="hidden lg:block">
        <DataTable title="Usuarios de Establecimientos" showExport={true} onExport={handleExport}>
                ...
                <TableRow key={user.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                      ...
                      user.role === 'agent' ? 'bg-green-600' : 'bg-purple-600'
                    } text-white`}>
      ...
      <div className="lg:hidden space-y-4">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-white">Usuarios de Establecimientos</h3>
          <button 
        ...
        {users.map((user) => (
          <div key={user.id} className="bg-gray-800/50 border border-gray-700 rounded-lg p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs text-gray-400">
              <div>
                <span className="font-medium">Establecimiento:</span> {user.company}
              </div>
              <div>
      ...
      <CreateUserModal
        ...
        establishments={[
          { id: '1', name: 'Establecimiento ABC' },
          { id: '2', name: 'Establecimiento XYZ' },
          { id: '3', name: 'Establecimiento 123' }
        ]}
      />
