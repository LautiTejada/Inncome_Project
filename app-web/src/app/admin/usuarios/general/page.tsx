...
import { FiUsers, FiSearch, FiPlus, FiEdit, FiTrash2, FiEye } from 'react-icons/fi';
import { PageLayout, DataTable, TableHeader, TableRow, CreateUserModal, UserDetailsModal, UserEditModal } from '@/components';

export default function UsuariosGeneralPage() {
  ...
  const [users, setUsers] = useState([
    ...
    },
    {
      id: '2',
      name: 'María González',
      email: 'maria.gonzalez@inncome.com',
      role: 'manager',
      status: 'active',
    ...
    },
    {
      ...
      email: 'carlos.rodriguez@inncome.com',
      role: 'agent',
      status: 'active',
  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:block">
        <DataTable title="Lista de Usuarios" showExport={true} onExport={handleExport}>
